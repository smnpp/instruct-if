...
public class Service {
    ...
    public Boolean lancerVisio(Soutien soutien) {
        ...
        try {
            ...
            success = true;
            } else {JpaUtil.annulerTransaction();}
        } catch (Exception e) {
            e.printStackTrace();
            JpaUtil.annulerTransaction();
    ...
    public void initialisation() {
        ...
        AutreIntervenant intervenant2 = new AutreIntervenant("Zola", "Anna", "0633221144", "tata", Arrays.asList(0, 1, 2, 3, 4, 5, 6),"Retraite");
        inscrireIntervenant(intervenant2);
        Enseignant intervenant3 = new Enseignant("Hugo", "Emile", "0788559944", "toto", Arrays.asList(3),"collège");
        inscrireIntervenant(intervenant3);
        AutreIntervenant intervenant4 = new AutreIntervenant("Yourcenar", "Simone", "0722447744", "titi", Arrays.asList(1, 2, 3, 4, 5),"médecin");
