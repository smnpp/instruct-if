...
public class JpaUtil {
     ...
     */
    public static final String PERSISTENCE_UNIT_NAME = "dasi_TD_jar_1.0-SNAPSHOTPU"; // Mise à jour du nom
    /**
    ...
    /**
     * Indicateur d'affichage du Log de JpaUtil. Par défaut, le Log de JpaUtil
     * s'affiche dans la console. Utiliser la méthode
     * <code>desactiverLog()</code> pour désactiver cet affichage.
     */
    ...
    /**
     * Méthode pour désactiver l'affichage du Log de JpaUtil. À utiliser avant
     * la méthode <code>creerFabriquePersistance()</code> pour également
     * désactiver le Log de la librairie EclipseLink.
     */
